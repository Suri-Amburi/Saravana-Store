...
FORM process_data  USING    p_git_file.
  ...
  READ TABLE git_file INTO DATA(w_file) INDEX 1.
  IF w_file-matnr IS NOT INITIAL AND w_file-ean11 IS NOT INITIAL.
  ...
  LOOP AT git_file ASSIGNING <fs_flatfile>.
    ...
    IF p1 = 'X'.     "Material
      ...
      PERFORM bdc_field       USING 'KOMG-MATNR(01)'
                                    <fs_flatfile>-matnr."'62290-38'.
      PERFORM bdc_field       USING 'KONP-KBETR(01)'
                                    <fs_flatfile>-kbetr."'              40'.
    ...
    ELSEIF p2 = 'X'. "Material/Batch
      ...
      PERFORM bdc_field       USING 'BDC_OKCODE'
                                    '/00'.
      PERFORM bdc_field       USING 'KOMG-MATNR(01)'
                                    <fs_flatfile>-matnr."'50039-22'.
      PERFORM bdc_field       USING 'KOMG-CHARG(01)'
                                    <fs_flatfile>-charg."'1000002338'.
      PERFORM bdc_field       USING 'KONP-KBETR(01)'
                                    <fs_flatfile>-kbetr."'              23'.
      PERFORM bdc_field       USING 'KONP-KONWA(01)'
                                    <fs_flatfile>-konwa."'INR'.
      PERFORM bdc_dynpro      USING 'SAPMV13A' '1511'.
      PERFORM bdc_field       USING 'BDC_CURSOR'
    ...
    ELSEIF p3 = 'X'. "Material/Serial
      ...
      PERFORM bdc_field       USING 'KOMG-MATNR(01)'
                                    <fs_flatfile>-matnr."'62290-38'.
      PERFORM bdc_field       USING 'KOMG-ZZSERNR(01)'
                                    <fs_flatfile>-sl."'1234'.
      PERFORM bdc_field       USING 'KONP-KBETR(01)'
                                    <fs_flatfile>-kbetr."'              40'.
      PERFORM bdc_field       USING 'KONP-KONWA(01)'
    ...
    ELSEIF p5 = 'X'. "Material/Vendor
      ...
      PERFORM bdc_field       USING 'KOMG-LIFNR'
                                    <fs_flatfile>-lifnr."'SC0010768'.
      PERFORM bdc_field       USING 'KOMG-MATNR(01)'
                                    <fs_flatfile>-matnr."'135187-10-11'.
      PERFORM bdc_field       USING 'KONP-KBETR(01)'
                                    <fs_flatfile>-kbetr."'             100'.
      PERFORM bdc_field       USING 'KONP-KONWA(01)'
                                    <fs_flatfile>-konwa."'INR'.
      PERFORM bdc_dynpro      USING 'SAPMV13A' '1502'.
      PERFORM bdc_field       USING 'BDC_CURSOR'
    ...
    ELSEIF p6 = 'X'. "Material/Plant
      ...
      PERFORM bdc_field       USING 'KOMG-MATNR(01)'
                                    <fs_flatfile>-matnr."'135215-10-11'.
      PERFORM bdc_field       USING 'KONP-KBETR(01)'
                                    <fs_flatfile>-kbetr."'              20'.
      PERFORM bdc_field       USING 'KONP-KONWA(01)'
                                    <fs_flatfile>-konwa."'inr'.
      PERFORM bdc_dynpro      USING 'SAPMV13A' '1406'.
      PERFORM bdc_field       USING 'BDC_CURSOR'
    ...
    ELSEIF p8 = 'X'.
      ...
      PERFORM bdc_field       USING 'RV130-SELKZ(08)'
                                    'X'.
      PERFORM bdc_dynpro      USING 'SAPMV13A' '1905'.
      PERFORM bdc_field       USING 'BDC_CURSOR'
                                    'KONP-KONWA(01)'.
      PERFORM bdc_field       USING 'BDC_OKCODE'
                                    '/00'.
...
**    ELSEIF p7 = 'X'. "Vendor Material Group
**
**      PERFORM bdc_dynpro      USING 'SAPMV13A' '0100'.
**      PERFORM bdc_field       USING 'BDC_CURSOR'
**                                    'RV13A-KSCHL'.
...
**                                    '/00'.
**      PERFORM bdc_field       USING 'KOMG-LIFNR'
**                                    <fs_flatfile>-lifnr."'SC0002423'.
**      PERFORM bdc_field       USING 'KOMG-MATKL(01)'
**                                    <fs_flatfile>-matkl."'BR04'.
**      PERFORM bdc_field       USING 'KONP-KBETR(01)'
**                                    <fs_flatfile>-kbetr.."'              20'.
**      PERFORM bdc_field       USING 'KONP-KONWA(01)'
**                                    <fs_flatfile>-konwa."'inr'.
...
**    ELSEIF p9 = 'X'.                                                                  "ZEAN Plant material
**
**      PERFORM bdc_dynpro      USING 'SAPMV13A' '0100'.
**      PERFORM bdc_field       USING 'BDC_CURSOR'
**                                    'RV13A-KSCHL'.
