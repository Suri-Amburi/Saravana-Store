...
*        END OF TY_MEPO1211.
    ...
    TYPES : BEGIN OF ty_mara,
     ...
     TYPES  : BEGIN OF ty_ekko,
              ...
              ZZCATEGORY_TYPE TYPE ZCAT_TYPE,                            " ADDED ON (8-6-20)
       END OF ty_ekko,
...
***************        added on (8-6-20)
*        IF WA_EK-ZZCATEGORY_TYPE = 'E'.
*        wa_poitem-WGBEZ = <wa_makt1>-maktx.
**        ENDIF.
*        ELSE.
*      wa_poitem-WGBEZ = <wa_t023t>-wgbez60.
*      endif.
...
*  WA_HEADER-NO_BUD    = WA_ZINW_T_HDR-NO_BUD.
    ...
    DATA : lv_heading(100) TYPE c,
           LV_MAT(100)     TYPE C,      " ADDDED ON (7-6-20
           lv_ref_po(30)   TYPE c,
           lv_bill_d(30)   TYPE c,
           p_aedat(10)     TYPE c.
    CLEAR : po_text.
...
*      "
      CALL FUNCTION 'SSF_FUNCTION_MODULE_NAME'
        EXPORTING
          formname           = 'ZPURCHASE_COPY'"'ZPURCHASE_ORDER_FORM'
        IMPORTING
          fm_name            = fmname
        EXCEPTIONS
          no_form            = 1
...
*          lv_ername            = lv_ername
*          po_qr                = lv_ebeln
*          LV_CODE              = LV_CODE                              " ADDED ON (8-6-20)
*        IMPORTING
