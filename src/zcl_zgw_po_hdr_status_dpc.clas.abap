class ZCL_ZGW_PO_HDR_STATUS_DPC definition
  public
...
protected section.
  ...
  methods HEADERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZGW_PO_HDR_STATUS_MPC=>TS_HEADER
    raising
  ...
  methods HEADERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGW_PO_HDR_STATUS_MPC=>TT_HEADER
...
CLASS ZCL_ZGW_PO_HDR_STATUS_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 19.09.2019 20:57:59 in client 400
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW_PO_HDR_STATUS_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA headerset_create_entity TYPE zcl_zgw_po_hdr_status_mpc=>ts_header.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA headerset_get_entity TYPE zcl_zgw_po_hdr_status_mpc=>ts_header.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW_PO_HDR_STATUS_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA headerset_get_entityset TYPE zcl_zgw_po_hdr_status_mpc=>tt_header.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA headerset_update_entity TYPE zcl_zgw_po_hdr_status_mpc=>ts_header.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
