*&---------------------------------------------------------------------*
*& Include          ZN_GSTR1_B2B_REPORT1_SUB
*&---------------------------------------------------------------------*
...
FORM select_querry .
  ...
  SELECT vbeln
         ...
         AND FKART = 'FP'                         " ADDED ON (16-02-20)
****         AND fkart IN ('ZDOM', 'ZDMC', 'ZDCW', 'ZTRO', 'ZTRC', 'ZDEP', 'ZJWO', 'ZSAM', 'ZF8', 'ZL2', 'ZSRI') "*---->>>  ADDED BY  mumair <<< 07.11.2019 11:42:46
         AND fksto NE 'X'.
*         AND FKART NOT IN ('ZF2' ,'ZF8' , 'S1' , 'ZRET' , 'ZSN' , 'ZSN1' , 'ZSN2' , 'ZSN3' , 'ZSN4' , 'ZSN5', 'ZSP', 'ZSP1' , 'ZSP2' ,
*                           'ZSP3' , 'ZSP4' , 'ZSP5' , 'ZCMO' , 'S2' ).
*         AND FKART NOT IN ('ZF2' , 'S1' , 'ZRET' , 'ZSN' , 'ZSN1' , 'ZSN2' , 'ZSN3' , 'ZSN4' , 'ZSN5', 'ZSP', 'ZSP1' , 'ZSP2' ,
*                           'ZSP3' , 'ZSP4' , 'ZSP5' , 'ZCMO' , 'S2' , 'ZEPF' , 'ZPFC' , 'ZPFI' , 'ZG2' , 'ZRE' , 'ZEPD' , 'ZFMS'    ).
...
***    else.
      ...
      wa_fin-netwr  =   wa_fin-netwr - ( wa_fin-tcs + wa_fin-ino + wa_fin-frt + wa_fin-ops + wa_fin-cess + wa_fin-diff ). "+ wa_fin-dis
