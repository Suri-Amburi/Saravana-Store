class ZCL_ZGW_PO_CREATE01_MPC definition
  public
...
TT_HEADER type standard table of TS_HEADER .
    ...
    TYPES:
      ...
      TT_DEEP_ENTITY TYPE STANDARD TABLE OF TS_DEEP_ENTITY.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW_PO_CREATE01_MPC=======CP' ##NO_TEXT.
...
CLASS ZCL_ZGW_PO_CREATE01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_PO_CREATE01_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20190828130851'.                  "#EC NOTEXT
