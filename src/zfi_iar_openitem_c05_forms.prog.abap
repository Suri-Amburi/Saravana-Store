...
FORM process_data  USING fp_i_exceltab TYPE ty_t_exceltab.
  ...
  DATA:wa_documentheader    TYPE bapiache09,
       ...
       i_accountreceivable  TYPE TABLE OF bapiacar09,
...
*    REPLACE ALL OCCURRENCES OF '.' IN lw_exceltab-zfbdt WITH '/'.
*    REPLACE ALL OCCURRENCES OF '-' IN lw_exceltab-zfbdt WITH '/'.
...
*    CLEAR : lv_year, lv_mon, lv_dat, lv_monc, lv_datc.
    ...
    CONDENSE:lw_exceltab-blart,lw_exceltab-xblnr,lw_exceltab-bukrs,
             lw_exceltab-newbs,lw_exceltab-newko,lw_exceltab-wrbtr,lw_exceltab-zuonr,lw_exceltab-gsber,
             lw_exceltab-kunnr,lw_exceltab-zuonr1,lw_exceltab-gsber1.
    ...
    wa_documentheader-doc_type   = lw_exceltab-blart. "'DR'.
    wa_documentheader-header_txt = lw_exceltab-sgtxt.


    wa_accountreceivable-itemno_acc    = '0000000001'.
    wa_accountreceivable-customer      = lw_exceltab-kunnr.
    ...
    wa_accountreceivable-comp_code     = lw_exceltab-bukrs.
    wa_accountreceivable-bline_date    = lv_date2.
    wa_accountreceivable-pmnttrms      = lw_exceltab-zterm.
*    wa_accountreceivable-businessplace = lw_exceltab-bupla.
*    wa_accountreceivable-sectioncode   = lw_exceltab-secco.
    wa_accountreceivable-bus_area      = lw_exceltab-gsber.
    wa_accountreceivable-alloc_nmbr    = lw_exceltab-zuonr.
    wa_accountreceivable-item_text     = lw_exceltab-sgtxt.
    ...
    IF lw_exceltab-newbs = '01' OR lw_exceltab-newbs = '02' OR lw_exceltab-newbs = '03' OR lw_exceltab-newbs = '04' OR
       lw_exceltab-newbs = '05' OR lw_exceltab-newbs = '06' OR lw_exceltab-newbs = '07' OR lw_exceltab-newbs = '08' OR
       lw_exceltab-newbs = '09'.
