CLASS ZCL_ZGW_MUL_POST_MPC DEFINITION
  PUBLIC
  ...
  TT_RETURN TYPE STANDARD TABLE OF TS_RETURN .
    ...
    TYPES:
      BEGIN OF TS_DEEP_ENTITY,
        ...
        NAVRESULT TYPE STANDARD TABLE OF TS_RETURN WITH DEFAULT KEY, "var name should be same as of navigation property name
...
CLASS ZCL_ZGW_MUL_POST_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_MUL_POST_SRV' ).
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'HEADER_ITEMSet'                         "#EC NOTEXT
 ...
 lo_association = model->create_association(
                            iv_association_name = 'HEADER_RETURN' "#EC NOTEXT
                            iv_left_type        = 'Header' "#EC NOTEXT
                            iv_right_type       = 'Return' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - HEADER_RETURN
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'PoNumber'   iv_dependent_property = 'Number' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'HEADER_RETURNSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'HeaderSet'              "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20190813100213'.                  "#EC NOTEXT
