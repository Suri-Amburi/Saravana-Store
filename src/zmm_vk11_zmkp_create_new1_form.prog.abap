...
**************************<fs_flatfile>-kschl."
  LOOP AT git_file ASSIGNING <fs_flatfile>.
    ...
    IF p1 = 'X'.
      ...
      PERFORM bdc_field       USING 'BDC_OKCODE'
                                    '=WEIT'.
      PERFORM bdc_dynpro      USING 'SAPMV13A' '1501'.
      PERFORM bdc_field       USING 'BDC_CURSOR'
                                    'KONP-KONWA(01)'.
      PERFORM bdc_field       USING 'BDC_OKCODE'
                                    '/00'.
      PERFORM bdc_field       USING 'KOMG-LIFNR(01)'
    ...
    ELSEIF p7 = 'X'.
      ...
      PERFORM bdc_field       USING 'RV130-SELKZ(07)'
                                    'X'.
      PERFORM bdc_dynpro      USING 'SAPMV13A' '1922'.
      PERFORM bdc_field       USING 'BDC_CURSOR'
                                    'KONP-KONWA(01)'.
      PERFORM bdc_field       USING 'BDC_OKCODE'
                                    '/00'.
    ...
    ELSEIF p8 = 'X'.
      ...
      PERFORM bdc_dynpro      USING 'SAPMV13A' '1923'.
      PERFORM bdc_field       USING 'BDC_CURSOR'
                                    'KONP-KONWA(01)'.
      PERFORM bdc_field       USING 'BDC_OKCODE'
                                    '=SICH'.
    ...
    ELSEIF p9 = 'X'.
      ...
      PERFORM bdc_field       USING 'RV130-SELKZ(01)'
                                    ''.
      PERFORM bdc_field       USING 'RV130-SELKZ(09)'
                                    'X'.
      PERFORM bdc_dynpro      USING 'SAPMV13A' '1524'.
      PERFORM bdc_field       USING 'BDC_CURSOR'
                                    'KONP-KONWA(01)'.
      PERFORM bdc_field       USING 'BDC_OKCODE'
                                    '/00'.
      PERFORM bdc_field       USING 'KOMG-LIFNR'
                                    <fs_flatfile>-lifnr."'SC0010768'.
      PERFORM bdc_field       USING 'KOMG-ZZGROUP(01)'
                                    'QWER'.
      PERFORM bdc_field       USING 'KONP-KBETR(01)'
                                    <fs_flatfile>-kbetr."'             101'.
      PERFORM bdc_field       USING 'KONP-KONWA(01)'
