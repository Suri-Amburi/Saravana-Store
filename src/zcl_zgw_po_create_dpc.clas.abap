class ZCL_ZGW_PO_CREATE_DPC definition
  public
...
protected section.
  ...
  methods HEADERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZGW_PO_CREATE_MPC=>TS_HEADER
    raising
  ...
  methods HEADERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGW_PO_CREATE_MPC=>TT_HEADER
  ...
  methods ITEMSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW_PO_CREATE_MPC=>TS_ITEM
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ITEMSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW_PO_CREATE_MPC=>TT_ITEM
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods RESULTSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW_PO_CREATE_MPC=>TS_RESULT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods RESULTSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW_PO_CREATE_MPC=>TT_RESULT
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZGW_PO_CREATE_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 21.09.2019 12:50:21 in client 400
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW_PO_CREATE_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA itemset_create_entity TYPE zcl_zgw_po_create_mpc=>ts_item.
 DATA resultset_create_entity TYPE zcl_zgw_po_create_mpc=>ts_result.
 DATA headerset_create_entity TYPE zcl_zgw_po_create_mpc=>ts_header.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA itemset_get_entity TYPE zcl_zgw_po_create_mpc=>ts_item.
 DATA resultset_get_entity TYPE zcl_zgw_po_create_mpc=>ts_result.
 DATA headerset_get_entity TYPE zcl_zgw_po_create_mpc=>ts_header.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW_PO_CREATE_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA itemset_get_entityset TYPE zcl_zgw_po_create_mpc=>tt_item.
 DATA resultset_get_entityset TYPE zcl_zgw_po_create_mpc=>tt_result.
 DATA headerset_get_entityset TYPE zcl_zgw_po_create_mpc=>tt_header.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA itemset_update_entity TYPE zcl_zgw_po_create_mpc=>ts_item.
 DATA resultset_update_entity TYPE zcl_zgw_po_create_mpc=>ts_result.
 DATA headerset_update_entity TYPE zcl_zgw_po_create_mpc=>ts_header.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
