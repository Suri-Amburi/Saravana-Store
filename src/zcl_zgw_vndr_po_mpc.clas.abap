class ZCL_ZGW_VNDR_PO_MPC definition
  public
...
public section.
  ...
  types:
     TS_PURCHASEORDER type ZGW_VNDR_PO_H .
  types:
TT_PURCHASEORDER type standard table of TS_PURCHASEORDER .
  ...
  types:
     TS_PURCHASEORDERITEM type ZGW_VNDR_PO_I .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW_VNDR_PO_MPC===========CP' ##NO_TEXT.

  methods DEFINE_PURCHASEORDER
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZGW_VNDR_PO_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_VNDR_PO_SRV' ).

define_purchaseorder( ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            ...
                            iv_left_type        = 'PurchaseOrder' "#EC NOTEXT
...
lo_ref_constraint->add_property( iv_principal_property = 'Vendor'   iv_dependent_property = 'Vendor' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'PurchaseOrderToPurchaseOrderItemSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'PurchaseOrderSet'              "#EC NOTEXT
...
* Navigation Properties for entity - PurchaseOrder
lo_entity_type = model->get_entity_type( iv_entity_name = 'PurchaseOrder' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ToPurchaseOrderItem' "#EC NOTEXT
                                                              iv_abap_fieldname = 'TOPURCHASEORDERITEM' "#EC NOTEXT
                                                              iv_association_name = 'PurchaseOrderToPurchaseOrderItem' ). "#EC NOTEXT
  endmethod.


  method DEFINE_PURCHASEORDER.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PurchaseOrder' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Transporter' iv_abap_fieldname = 'TRANSPORTER' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'LeadTime' iv_abap_fieldname = 'LEAD_TIME' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZGW_VNDR_PO_H'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PurchaseOrderSet' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CategoryNo' iv_abap_fieldname = 'CATEGORY_NO' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'SizeI' iv_abap_fieldname = 'SIZE_I' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZGW_VNDR_PO_I'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20191009120611'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'Supervisor'.                 "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'Transporter'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'PurchaseOrder'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Dat'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'PurchaseOrder'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'LeadTime'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'PurchaseOrder'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'SizeI'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
