...
DATA :
  ...
  LV_DATE1  TYPE BEGDA,
  LV_DATE2  TYPE BEGDA,
  LT_DAYS   TYPE STANDARD TABLE OF TY_DAYS.

FIELD-SYMBOLS :
  <LS_KLAH_H> TYPE TY_KLAH_H,
  <LS_KLAH_I> TYPE TY_KLAH_I,
  <LS_DAYS>   TYPE TY_DAYS.

CONSTANTS :
  C_STATUS(2) VALUE '02', " 02  Gate Entry Created
  C_X(1)      VALUE 'X'.
...
*** Calculating Diff between days
        CALL FUNCTION 'DAYS_BETWEEN_TWO_DATES'
          EXPORTING
            ...
            I_KZ_ULT_BIS            = SPACE
            I_KZ_ULT_VON            = SPACE
            I_STGMETH               = '0'    " Interest calculation method
        ...
        IF SY-SUBRC <> 0.
        ENDIF.
*        ADD LV_DAYS TO WA_FINAL-DAYS.
        APPEND VALUE #( CLASS = <LS_KLAH_I>-CLASS DAYS = LV_DAYS ) TO LT_DAYS.
      ENDLOOP.
    ENDLOOP.

    SORT LT_DAYS BY DAYS DESCENDING.
    READ TABLE LT_DAYS ASSIGNING <LS_DAYS> INDEX 1.
    IF SY-SUBRC = 0.
      WA_FINAL-DAYS  = <LS_DAYS>-DAYS.
    ENDIF.
...
*  CLEAR LS_FIELDCAT.
  ...
  LS_FIELDCAT-SELTEXT_L   = 'Storage Days'.
*  LS_FIELDCAT-REF_TABNAME = 'LT_FINAL'.
  LS_FIELDCAT-OUTPUTLEN   = 10.
  APPEND LS_FIELDCAT TO LT_FIELDCAT.
  CLEAR LS_FIELDCAT.
