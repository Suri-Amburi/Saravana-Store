...
*      centraldata-partnertype          = <fs_flatfile>-bpkind.
      ...
      CENTRALDATA_X-SEARCHTERM1 =  'X'.
*        centraldata-partnertype
      CENTRALDATA_X-DATAORIGINTYPE = 'X'.
...
*      CLEAR WA_TELEFONDATA.
      WA_TELEFONDATANONADDRESS-TELEPHONE = <FS_FLATFILE>-TEL_NUMBER.
      WA_TELEFONDATANONADDRESS-EXTENSION = <FS_FLATFILE>-TEL_EXTENS.
      APPEND WA_TELEFONDATANONADDRESS TO IT_TELEFONDATANONADDRESS.
      CLEAR WA_TELEFONDATANONADDRESS.

      WA_TELEFONDATANONADDRESSX-TELEPHONE = 'X'.
      WA_TELEFONDATANONADDRESSX-EXTENSION = 'X'.
      WA_TELEFONDATANONADDRESSX-TEL_NO = 'X'.
      WA_TELEFONDATANONADDRESSX-COUNTRY = 'X'.
      APPEND WA_TELEFONDATANONADDRESSX TO IT_TELEFONDATANONADDRESSX.
      CLEAR WA_TELEFONDATANONADDRESSX.
...
*      CLEAR WA_FAXDATA.
      WA_FAXDATANONADDRESS-FAX       = <FS_FLATFILE>-FAX_NUMBER.
      APPEND WA_FAXDATANONADDRESS TO IT_FAXDATANONADDRESS.
      CLEAR WA_FAXDATANONADDRESS.

      WA_FAXDATANONADDRESSX-FAX       = 'X'.
      WA_FAXDATANONADDRESSX-FAX_NO    = 'X'.
      WA_FAXDATANONADDRESSX-COUNTRY    = 'X'.
      APPEND WA_FAXDATANONADDRESSX TO IT_FAXDATANONADDRESSX.
      CLEAR WA_FAXDATANONADDRESSX.
*      WA_E_MAILDATA-E_MAIL = <FS_FLATFILE>-SMTP_ADDR.
*      APPEND WA_E_MAILDATA TO IT_E_MAILDATA.
*      CLEAR WA_E_MAILDATA.
      WA_E_MAILDATANONADDRESS-E_MAIL = <FS_FLATFILE>-SMTP_ADDR.
      WA_E_MAILDATANONADDRESS-STD_NO = 'X'.
      WA_E_MAILDATANONADDRESS-STD_RECIP = 'X'.
      APPEND WA_E_MAILDATANONADDRESS TO IT_E_MAILDATANONADDRESS.
      CLEAR WA_E_MAILDATANONADDRESS.

      WA_E_MAILDATANONADDRESSX-E_MAIL = 'X'.
      WA_E_MAILDATANONADDRESSX-STD_NO = 'X'.
      WA_E_MAILDATANONADDRESSX-UPDATEFLAG = 'I'.
      APPEND WA_E_MAILDATANONADDRESSX TO IT_E_MAILDATANONADDRESSX.
      CLEAR WA_E_MAILDATANONADDRESSX.
...
*         DUPLICATE_CHECK_ADDRESS   =
        TABLES
          TELEFONDATANONADDRESS     = IT_TELEFONDATANONADDRESS
          FAXDATANONADDRESS         = IT_FAXDATANONADDRESS
*         TELETEXDATANONADDRESS     =
*         TELEXDATANONADDRESS       =
          E_MAILDATANONADDRESS      = IT_E_MAILDATANONADDRESS
*         E_MAILDATANONADDRESS      = IT_E_MAILDATA
...
*         COMMUNICATIONUSAGENONADDRESS        =
          TELEFONDATANONADDRESSX    = IT_TELEFONDATANONADDRESSX
          FAXDATANONADDRESSX        = IT_FAXDATANONADDRESSX
*         TELETEXDATANONADDRESSX    =
*         TELEXDATANONADDRESSX      =
          E_MAILDATANONADDRESSX     = IT_E_MAILDATANONADDRESSX
...
*         ADDRESSDUPLICATES         =
      ...
      SORT IT_RETURN1 BY TYPE.
      DELETE IT_RETURN1 WHERE TYPE = 'S' OR TYPE = 'W'.
...
**************end************************************************************************
            ...
            LOOP AT IT_RETURN INTO WA_RETURN WHERE TYPE = 'S'.
              WA_DISPLAY-ID      = WA_RETURN-TYPE.
              WA_DISPLAY-BP_NUM  = PARTNER.
              WA_DISPLAY-MESSAGE = 'S' .                           "WA_RETURN-MESSAGE.
*          WA_DISPLAY-SORT = <FS_FLATFILE>-SORT1.
              APPEND WA_DISPLAY TO IT_DISPLAY.
              CLEAR:WA_DISPLAY,WA_RETURN.
            ENDLOOP.
            ...
            LOOP AT IT_DISPLAY INTO WA_DISPLAY WHERE BP_NUM  = PARTNER.
              WA_DISPLAY-LIFNR = EV_LIFNR.
              WA_DISPLAY-SORT = <FS_FLATFILE>-SORT1.
              WA_DISPLAY-MESSAGE = 'Success'.
              WA_DISPLAY-ID = 'S'.
              MODIFY IT_DISPLAY FROM WA_DISPLAY TRANSPORTING LIFNR SORT MESSAGE ID.
            ENDLOOP.
          ELSE.
