*&---------------------------------------------------------------------*
*& Include SAPMZMM_SUBCON_SALES_TOP                 - Module Pool      SAPMZMM_SUBCON_SALES
*&---------------------------------------------------------------------*
PROGRAM sapmzmm_subcon_sales.
...
TYPES : BEGIN OF ty_hdr,
          werks     TYPE zsubcon_wrk, "Plant
          pdesc     TYPE name1,   "Plant Description
          matnr     TYPE matnr,   "Material
          maktx     TYPE maktx,   "Material Descriptions
          charg     TYPE charg_d, "Batch
          menge     TYPE menge_d, "Quantity
          meins     TYPE meins,   "Unit of measure
          text      TYPE text30,  "Free Text fro set description
          chargean  TYPE char13,  "Component
          mblnr_541 TYPE mblnr, "Material Document
          mjahr_541 TYPE mjahr, "Material Doc.Year
          mblnr_101 TYPE mblnr, "Material Document
          mjahr_101 TYPE mjahr, "Material Doc.Year
          sprice    TYPE netpr,    "Price
          waers     TYPE waers,    "Currency
        END OF ty_hdr.

DATA : xsubcon_hdr TYPE ty_hdr. "Header Inputs

DATA : xsubcon_itm TYPE TABLE OF zsubcon_itms WITH HEADER LINE. "Item Details
...
CONSTANTS : title TYPE string VALUE 'SET Component Details'.
