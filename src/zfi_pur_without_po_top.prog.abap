*&---------------------------------------------------------------------*
*& Include          ZFI_PUR_WITHOUT_PO_TOP
*&---------------------------------------------------------------------*
...
SELECT-OPTIONS:s_gsber FOR lv_gsber,"  OBLIGATORY,
               s_ebeln FOR lv_ebeln,  "Purchase Document
               s_belnr FOR lv_belnr,  "MIRO Document
               s_gjahr FOR lv_gjahr,  "Fiscal Year
               s_budat FOR lv_budat OBLIGATORY,  "Posting_date
               s_lifnr FOR ekko-lifnr ,"NO-DISPLAY,   "No direct_input_available_for_vendor
               s_nr FOR lv_ebeln NO-DISPLAY.
