class ZCL_ZGW_PO_ITEM_DETAIL_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW_PO_ITEM_DETAIL_MPC====CP' ##NO_TEXT.
...
CLASS ZCL_ZGW_PO_ITEM_DETAIL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_PO_ITEM_DETAILS_SRV' ).
...
lo_property = lo_entity_type->create_property( iv_property_name = 'Days' iv_abap_fieldname = 'DAYS' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'BapiMsg' iv_abap_fieldname = 'BAPI_MSG' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_PO_ITEM_DETAIL_MPC=>TS_ITEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20190919161132'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'Days'.                 "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Txz01'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Item'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'BapiMsg'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Item'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
