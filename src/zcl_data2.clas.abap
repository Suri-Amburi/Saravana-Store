CLASS zcl_data2 DEFINITION
 PUBLIC
  ...
  TYPES : BEGIN OF ty_data,
          ...
          tt_data2 TYPE STANDARD TABLE OF ty_data.



         CLASS-METHODS : gt_data2
          EXPORTING
           VALUE(et_data) TYPE tt_data2.

  PROTECTED SECTION.
  PRIVATE SECTION.

ENDCLASS.
CLASS zcl_data2 IMPLEMENTATION.
  METHOD gt_data2  BY DATABASE PROCEDURE FOR HDB LANGUAGE SQLSCRIPT OPTIONS READ-ONLY USING NSDM_V_MCHB zb1_stock.
