...
*******************************************************************
  INCLUDE LZCUST_TABTOP.                     " Global Declarations
  INCLUDE LZCUST_TABUXX.                     " Function Modules

*******************************************************************
*   User-defined Include-files (if necessary).                    *
*******************************************************************
* INCLUDE LZCUST_TABF...                     " Subroutines
* INCLUDE LZCUST_TABO...                     " PBO-Modules
* INCLUDE LZCUST_TABI...                     " PAI-Modules
* INCLUDE LZCUST_TABE...                     " Events
* INCLUDE LZCUST_TABP...                     " Local class implement.
* INCLUDE LZCUST_TABT99.                     " ABAP Unit tests
