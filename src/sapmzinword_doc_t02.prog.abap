...
*** Purchage Tax Amount
        ...
        IF SY-SUBRC = 0.
          ...
          LOOP AT LT_TAX_CODE ASSIGNING FIELD-SYMBOL(<LS_TAX_CODE>) WHERE MWSKZ = <LS_EKPO>-MWSKZ.
            ...
            ENDIF.
          ENDLOOP.
*        IF <LS_ITEM>-NETWR_P IS NOT INITIAL.
*          DATA(LV_TX) = ( <LS_ITEM>-NETPR_GP / <LS_ITEM>-NETWR_P ) * 100.
*        ENDIF.
          CLEAR: LV_LINES.
...
***       Checking MRP Condition record Maintained or Not / EAN Managed material
          READ TABLE LT_MARA ASSIGNING FIELD-SYMBOL(<LS_MARA>) WITH KEY MATNR = <LS_ITEM>-MATNR NUMTP = C_UC.
          IF SY-SUBRC = 0.
