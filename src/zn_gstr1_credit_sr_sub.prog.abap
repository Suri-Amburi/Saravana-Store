*&---------------------------------------------------------------------*
*& Include          ZN_GSTR1_CREDIT_SR_SUB
*&---------------------------------------------------------------------*
...
*    READ TABLE it_fin3 INTO wa_fin3 WITH KEY belnr1 = wa_fin-belnr1 .
*    IF sy-subrc EQ 0 .
*      IF wa_fin3-igst IS NOT INITIAL .
*        DELETE it_fin.
*      ENDIF .
*      IF wa_fin3-cgst IS NOT INITIAL .
*        DELETE it_fin .
*      ENDIF .
*    ENDIF .
*    CLEAR wa_fin.
*  ENDLOOP .
  ...
  DELETE it_fin WHERE cgst IS NOT INITIAL.
  DELETE it_fin WHERE igst IS NOT INITIAL.
*  DELETE it_fin WHERE sgst IS NOT INITIAL.
